...
const Island = ({ isRotating, setIsRotating, ...props }) => {
    ...
    useFrame(()=>{ //'hook' from three fiber --> will be applied of every single frame
        if (!isRotating){
            rotationSpeed.current *= dampingFactor; // will get slower and slower until it slows down
